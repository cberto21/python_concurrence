...
if __name__ == '__main__':
    ...
    worker_1 = multiprocessing.Process(target=crearAnimacion(10,10, 'X'))
    worker_2 = multiprocessing.Process(target=crearAnimacion(10,10, 'Y'))
    worker_3 = multiprocessing.Process(target=crearAnimacion(10,10, 'Z'))
